// Proxy to Python /api/kb/archive-trends — converts the just-run trend bundle
// into chunked + embedded RAG chunks. Same SSE wire format as /api/kb/ingest.
...
export async function POST(req: Request): Promise<Response> {
  ...
  try {
    const upstream = await fetch(`${BACKEND}/api/kb/archive-trends`, {
      method: 'POST',
